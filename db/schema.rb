...
ActiveRecord::Schema[7.0].define(version: 2022_06_29_004331) do
  ...
  create_table "pay_elements", force: :cascade do |t|
    t.string "name", null: false
    t.integer "category_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_pay_elements_on_category_id"
  end
  ...
  add_foreign_key "pay_categories", "parents"
  add_foreign_key "pay_elements", "categories"
